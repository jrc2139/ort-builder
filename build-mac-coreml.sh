...
# This creates a static library that includes the CoreML execution provider
set -euf -o pipefail
...
OUTPUT_LIB="libonnxruntime-macOS_${ARCH}_coreml.a"
...
echo ""
echo "To use in fastembed-zig:"
echo "  cp ${OUTPUT_LIB} ../fastembed-zig/deps/onnxruntime-static/lib/libonnxruntime_all.a"
echo "  cp onnxruntime/include/onnxruntime/core/session/*.h ../fastembed-zig/deps/onnxruntime-static/include/"
echo "  cp onnxruntime/include/onnxruntime/core/providers/coreml/coreml_provider_factory.h ../fastembed-zig/deps/onnxruntime-static/include/"
